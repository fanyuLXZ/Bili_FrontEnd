    ...
    <div data-v-1c9150a9="" class="router-view" style="">
      <div data-v-247edaf8="" data-v-1c9150a9="" class="d">
        <div data-v-12ea5675="" data-v-247edaf8="" class="bili-im">
          ...
          <whisperleft :session_list="session_list" :datauser="datauser" @sindex="sindex"
                       @userid="userid"></whisperleft>
          <whisperright :session_list="session_list" :datauser="datauser" :messages="messages"
                        :sindext="sindext"></whisperright>
