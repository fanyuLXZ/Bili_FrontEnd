...
export default {
  ...
  computed: {
    // 取年月日
    time() {
      const t = (this.info && this.info.create) || ''
      return t.split(' ')[0]
    }
  },
}
