  ...
  <div id="page-video" class="wrapper">
    <div class="col-full clearfix">
      ...
      <div class="main-content">
        <page-head @iocns="iocns"/>
        <video-type/>
        <submit-video v-if="1==iocnsid"/>
        <cube-list v-if="2==iocnsid"/>
        <pagin-ation :current='3' :total='20' v-if="1==iocnsid"/>
      </div>
    </div>
  </div>
</template>
...
import PaginAtion from '../../beat/pagination/index'
...
#page-video .play-all-btn, #page-video .video-title {
  display: -ms-flexbox;
  display: flex;
...
#page-video #submit-video-type-filter.loading {
  text-indent: -9999px
}
...
#page-video .search-empty-hint .btn-container {
  margin-top: 25px
}

#page-video .search-empty-hint .normal {
  color: #99a2aa
}

#page-video .search-empty-hint .normal:hover {
  color: #00a1d6
}
...
#page-video .list-item:nth-last-child(2) {
  border-bottom: none
}

#page-video .list-item .cover img {
  width: 160px;
  height: 100px
}

#page-video .list-item .c {
  margin-right: 10px
}

#page-video .list-item .desc {
  height: 40px;
  margin-bottom: 17px
}

#page-video .list-item .meta > span {
  float: left;
  width: 100px
}

#page-video .list-item .meta > span.time {
  width: 170px
}
...
@media (min-width: 1420px) {
  ...
  #page-video .small-item {
    width: 190px
  }

  #page-video .list-item .cover img, #page-video .small-item .cover, #page-video .small-item img {
    width: 190px;
    height: 119px
  }
