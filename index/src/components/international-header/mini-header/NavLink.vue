    ...
    <ul class="nav-link-ul" :class="{'mini': navType === 0}">
      <li class="nav-link-item" v-van-report:mininav-click.click="`首页`" @mouseover="popoverChannelShow = true">
        ...
        <van-popover
          ...
          <a class="link" href="//www.bilibili.com">
            <slot name="reference">
      ...
      <li class="nav-link-item" v-van-report:mininav-click.click="`番剧`">
        <a class="link" href="//www.bilibili.com/anime/" target="_blank">{{this.$store.$HeadLang['1']}}</a>
      </li>
      <li class="nav-link-item" v-van-report:mininav-hover.mouseenter="`游戏中心`" @mouseover="popoverGameShow = true">
        <van-popover
          ...
          <a  class="link" href="https://game.bilibili.com/platform/" target="_blank" v-van-report:mininav-click.click="`游戏中心`">
            <slot name="reference">
              {{this.$store.$HeadLang['3']}}
            </slot>
          </a>
        </van-popover>
      </li>
      <li class="nav-link-item" v-van-report:mininav-hover.mouseenter="`直播`" @mouseover="popoverLiveShow = true">
        <van-popover
          ...
          <a class="link" href="//live.bilibili.com" target="_blank" v-van-report:mininav-click.click="`直播`">
            <slot name="reference">
              {{ this.$store.$HeadLang['39'] }}
            </slot>
          </a>
        </van-popover>
      </li>
      <li class="nav-link-item" v-van-report:mininav-click.click="`会员购`">
        <a class="link" href="//show.bilibili.com/platform/home.html?msource=pc_web" target="_blank">{{this.$store.$HeadLang['4']}}</a>
      </li>
      <li class="nav-link-item" v-van-report:mininav-hover.mouseenter="`漫画`" @mouseover="popoverMangaShow = true">
        <van-popover
          ...
          <a class="link" href="//manga.bilibili.com?from=bill_top_mnav" target="_blank" v-van-report:mininav-click.click="`漫画`">
            <slot name="reference">
              {{this.$store.$HeadLang['5']}}
            </slot>
          </a>
        </van-popover>
      </li>
      <li class="nav-link-item" v-van-report:mininav-click.click="`赛事`">
        <a class="link" href="//www.bilibili.com/v/game/match/" target="_blank">{{this.$store.$HeadLang['69']}}</a>
      </li>
      ...
      <li class="nav-link-item" v-van-report:mininav-hover.mouseenter="`下载app`" @mouseover="popoverAppShow = true">
        <van-popover
          ...
          transition="slide-fade"
          trigger="hover">
          <p v-if="popoverAppShow" class="txt">{{this.$store.$HeadLang['7']}}</p>
          <a class="link" href="//app.bilibili.com" target="_blank" v-van-report:mininav-click.click="`下载app`">
            <slot name="reference">
              <i class="bilifont bili-icon_dingdao_xiazaiapp"></i>{{this.$store.$HeadLang['6']}}
            </slot>
          </a>
        </van-popover>
      </li>
