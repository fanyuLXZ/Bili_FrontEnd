<template>
  <article id="app" class="tpl-wrap">
    ...
    <section class="plat-section-outter-box container-wrapper" data-fid="M9HXkxv_Kr" style="min-width:980px">
      <div class="t-space-container plat-section-space"
           style="padding: 0;width:980px">
        <div id="M9HXkxv_Kr" class="plat-section-inner-box a-wrap-module report-wrap-module report-scroll-module"
             data-container="section" data-module="code-block" data-version="0.0.6" scrollshow="true">
          <div></div>
        </div>
      </div>
    </section>
