<template>
  <div id="app">
    <international-header :bannerData="bannerData" :lang="LNG" :navType="1"/>
    <FirstScreen/>
...
import InternationalHeader from "./international-header/international-header.vue";
import InternationalFooter from "./international-footer";
import FirstScreen from "./international-home/first-screen"
import Storey from "./international-home/storey"
