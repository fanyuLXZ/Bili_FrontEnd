...
(function (self, undefined) {
    ...
    if (!("defineProperty" in Object && function () {
        ...
        !function (e) {
            ...
            Object.defineProperty = function n(o, i, c) {
                ...
                var a = String(i), f = "value" in c || "writable" in c, p = "get" in c && typeof c.get,
    ...
    if (!("forEach" in Array.prototype
        ...
        CreateMethodProperty(Array.prototype, "forEach", function r(t) {
            var e = ToObject(this), n = e instanceof String ? e.split("") : e, o = ToLength(Get(e, "length"));
    ...
    if (!("indexOf" in Array.prototype
        ...
        CreateMethodProperty(Array.prototype, "indexOf", function r(t) {
            var e = ToObject(this), n = ToLength(Get(e, "length"));
            if (0 === n) return -1;
            var i = ToInteger(arguments[1]);
            if (i >= n) return -1;
            if (i >= 0) var o = 1 / i == -Infinity ? 0 : i; else (o = n + i) < 0 && (o = 0);
            for (; o < n;) {
    ...
    if (!("getOwnPropertyDescriptor" in Object && "function" == typeof Object.getOwnPropertyDescriptor && function () {
        ...
        !function () {
            var e = Object.getOwnPropertyDescriptor, t = function () {
                try {
    ...
    if (!("keys" in Object && function () {
        ...
        CreateMethodProperty(Object, "keys", function () {
            ...
            var e = Object.prototype.hasOwnProperty, r = Object.prototype.toString,
                n = Object.prototype.propertyIsEnumerable, o = !n.call({toString: null}, "toString"),
                l = n.call(function () {
                }, "prototype"),
            ...
            return function p(n) {
                ...
                if (u && n.length > 0) for (var g = 0; g < n.length; ++g) p.push(String(g)); else for (var h in n) s && "prototype" === h || !e.call(n, h) || p.push(String(h));
                if (o) for (var w = f(n), d = 0; d < c.length; ++d) w && "constructor" === c[d] || !e.call(n, c[d]) || p.push(c[d]);
                return p
            }
        }());
    }
    ...
    if (!("defineProperties" in Object
        ...
        CreateMethodProperty(Object, "defineProperties", function e(r, t) {
            ...
            for (var o = ToObject(t), n = Object.keys(o), c = [], i = 0; i < n.length; i++) {
                var b = n[i], f = Object.getOwnPropertyDescriptor(o, b);
    ...
    if (!("create" in Object
        ...
        !function () {
            ...
            if ({__proto__: null} instanceof Object) t = function () {
            ...
            CreateMethodProperty(Object, "create", function o(n, r) {
                ...
                if ("null" === Type(n)) var l = t(); else e.prototype = n, l = new e, l.__proto__ = n, l.constructor.prototype = n, l.__proto__ = n;
    ...
    if (!("getOwnPropertyNames" in Object && function () {
        ...
        !function () {
            var t = {}.toString, e = "".split, r = [].concat, o = Object.prototype.hasOwnProperty,
                c = Object.getOwnPropertyNames || Object.keys, n = "object" == typeof self ? c(self) : [];
    ...
    if (!("Symbol" in self && 0 === self.Symbol.length
        ...
        !function (t, r, n) {
            "use strict";
            var e, u = 0, o = "" + Math.random(), l = "__symbol:", c = l.length, a = "__symbol@@" + o,
                ...
                g = Array.prototype.concat, w = t.getOwnPropertyNames ? t.getOwnPropertyNames(self) : [], S = t[s],
                d = function L(t) {
    ...
    if (!("Promise" in self
        ...
        !function () {
            ...
            var T, b, R, S = null, C = "object" == typeof self, F = self, P = F.Promise, E = F.process, H = F.console,
                I = !0, L = Array, A = Error, O = 1, U = 2, $ = 3, q = "Symbol", z = "iterator", B = "species",
                D = q + "(" + B + ")", G = "return", J = "_uh", K = "_pt", M = "_st", N = "Invalid argument",
                Q = "\nFrom previous ", V = "Chaining cycle detected for promise", W = "rejectionHandled",
                X = "unhandledRejection", Y = {e: S}, Z = function () {
